        ...
        <div className="w-full max-w-[420px]">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-400 font-bold uppercase tracking-widest text-[10px]">
              {mode === 'login' ? 'Portal Access Control' : 'Secure Health Registration'}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="password" className="text-[10px] font-black uppercase tracking-widest text-gray-400">
                {mode === 'login' ? 'Security Key' : 'Choose Password'}
              </Label>
            ...
            {error && (
              <div className={cn(
                "p-4 text-xs font-bold rounded-2xl border",
            ...
            <Button 
              ...
              disabled={isLoading}
            >
              {isLoading ? "Authenticating..." : mode === 'login' ? "Synchronize Session" : "Create My Account"}
            </Button>
          </form>
          ...
          <div className="text-center text-xs font-bold text-gray-400 mt-12 tracking-wide uppercase">
            {mode === 'login' ? "New to CareSync?" : "Already have an account?"}{" "}
            <button 
              onClick={() => {
